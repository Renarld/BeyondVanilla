...
public class LootSlimeOverlayFeatureRenderer<T extends LivingEntity> extends FeatureRenderer<T, LootSlimeEntityModel<T>> {
    private final EntityModel<T> model = new LootSlimeEntityModel<>(0);

    public LootSlimeOverlayFeatureRenderer(FeatureRendererContext<T, LootSlimeEntityModel<T>> featureRendererContext) {
